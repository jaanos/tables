...
wget -N -r --no-parent http://aeb.win.tue.nl/graphs/
wget -N -r --no-parent http://aeb.win.tue.nl/drg/drgtables.html
...
wget -N -r --no-parent --no-if-modified-since http://ericmoorhouse.org/pub/planes25/
wget -N -r --no-parent --no-if-modified-since http://ericmoorhouse.org/pub/planes27/
wget -N -r --no-parent --no-if-modified-since http://ericmoorhouse.org/pub/planes32/
